...
const Gallery = () => {
  // Event sections data - using the same image for now
  const events = [
    {
      id: 'flair-haven',
      name: 'Flair-Haven',
      images: Array(4).fill(memories1), // 4 images for 2x2 grid
    },
    {
      id: 'version-beta',
      name: 'Version-Beta',
    ...
    },
    {
      id: 'codathon',
      name: 'Codathon',
      images: Array(6).fill(memories1), // 6 images for variable grid
    },
  ];
  ...
  // Get animation direction based on index (alternate left/right)
